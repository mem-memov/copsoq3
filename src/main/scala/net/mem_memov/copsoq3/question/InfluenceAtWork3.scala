...
object InfluenceAtWork3 extends Question:

  override val code: String = "IN3"
  ...
  override val label: String = "Amount of work"

  override val text: String = "Can you influence the amount of work assigned to you?"
