...
object SomaticStress2 extends Question:

  override val code: String = "SO2"
  ...
  override val label: String = "Headache"

  override val text: String = "How often have you had a headache?"
