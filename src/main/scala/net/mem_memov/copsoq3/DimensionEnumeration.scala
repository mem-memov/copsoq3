...
enum DimensionEnumeration(dimension: Dimension):
  ...
  case ConflictsAndQuarrels extends DimensionEnumeration(dimension.ConflictsAndQuarrels)
  case UnpleasantTeasing extends DimensionEnumeration(dimension.UnpleasantTeasing)
  case CyberBullying extends DimensionEnumeration(dimension.CyberBullying)
  case SexualHarassment extends DimensionEnumeration(dimension.SexualHarassment)
  case ThreatsOfViolence extends DimensionEnumeration(dimension.ThreatsOfViolence)
  case PhysicalViolence extends DimensionEnumeration(dimension.PhysicalViolence)
  case Bullying extends DimensionEnumeration(dimension.Bullying)
  case SelfRatedHealth extends DimensionEnumeration(dimension.SelfRatedHealth)
  case SleepingTroubles extends DimensionEnumeration(dimension.SleepingTroubles)
  case Burnout extends DimensionEnumeration(dimension.Burnout)
  case Stress extends DimensionEnumeration(dimension.Stress)
  case SomaticStress extends DimensionEnumeration(dimension.SomaticStress)
  case CognitiveStress extends DimensionEnumeration(dimension.CognitiveStress)
  case DepressiveSymptoms extends DimensionEnumeration(dimension.DepressiveSymptoms)
  case SelfEfficacy extends DimensionEnumeration(dimension.SelfEfficacy)